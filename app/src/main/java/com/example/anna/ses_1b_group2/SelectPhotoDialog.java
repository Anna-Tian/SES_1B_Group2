...
public class SelectPhotoDialog extends DialogFragment{
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
         ...
         */
        if (requestCode == PICKFILE_REQUEST_CODE && requestCode == Activity.RESULT_OK){
         ...
         */
        else if (requestCode == PICKFILE_REQUEST_CODE && requestCode == Activity.RESULT_OK){
            Log.d(TAG, "onActivityResult: done taking new photo");
            Bitmap bitmap;
            bitmap = (Bitmap) data.getExtras().get("data");
            //send the uri to PostFragment & dismiss dialog
            mOnPhotoSeletedListener.getImageBitmap(bitmap);
            getDialog().dismiss();
        }
    }
    ...
    public void onAttach(Context context) {
        try {
            mOnPhotoSeletedListener = (OnPhotoSeletedListener)getActivity();
