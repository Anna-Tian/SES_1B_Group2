...
public class ViewPostFragment extends Fragment {
    ...
    //widgets
    private TextView mTitle, mDescription, mSavePost;
    ...
    private void init(){
        ...
        Fragment fragment = (Fragment)((MediaActivity)getActivity()).getSupportFragmentManager()
                .findFragmentByTag("android:switcher:" + R.id.viewpager_container + ":" +
                        ((MediaActivity)getActivity()).mViewPager.getCurrentItem());
        if(fragment != null){
